document.addEventListener('DOMContentLoaded', () => {
    ...
    const modalTriggers = {
        'Studiespesialisering': 'studiespesialisering-modal',
        'Medier og kommunikasjon': 'medier-modal',
        'Idrettsfag': 'idrett-modal'
    };

    document.querySelectorAll('.program-card').forEach(card => {
        card.addEventListener('click', () => {
            const title = card.querySelector('h3').textContent;
            const modalId = modalTriggers[title];
            if (modalId) {
    ...
    // Keyboard navigation for program cards
    document.querySelectorAll('.program-card').forEach(card => {
